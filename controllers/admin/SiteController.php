...
class SiteController extends Admin {
    ...
    public function __construct() {
		...
		$this->string = array(
			...
			'SITE_TEL'				    => lang('a-site-tcp'),
            'SITE_JS'                   => lang('a-site-tps'),
            'SITE_LOGO'                 => lang('a-site-logo'),
			'SITE_LOGIN'                => lang('登录页面LOGO'),
			'SITE_FXKEFU'               => lang('个人中心客服列表'),
			'SITE_ADMIN_PAGESIZE'       => 'Backstage paging number',
            'SITE_WEB_PAGESIZE'         => 'Front page number',
            'FILE_SIZE'                 => lang('上传文件大小'),
            'SMS_USERNAME'              => 'sms_username',
            'SMS_PASSWORD'              => 'sms_password',
            'ROADBUL_USERNAME'          => '物流接口账号',
            'ROADBUL_PASSWORD'          => '物流接口密码',
            'DELIVERY_NAME'             => '平台寄/收件人',
            'DELIVERY_CODE'             => '平台寄/收邮编',
            'DELIVERY_ADDRESS'          => '平台寄/收地址',
            'DELIVERY_PHONE'            => '平台寄/收电话',
        );
	}
