    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                ulhtml = '<ul style="left:' + left + 'px; top:-' + data.height + 'px"><li style="display:inline;">0</li></ul></div>';
                style = data.fontSize
                    ? ' style="width:' + data.width + 'px; height:' + data.height + 'px; display: inline-block;"'
                    : ' style="display: inline-block;"';
                dhtml1 = '<div class="first"' + style + '>' + ulhtml;
                dhtml2 = '<div' + style + '>' + ulhtml;
                dot2 = '<span style="display: inline-block;">:</span>';
